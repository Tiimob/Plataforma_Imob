...
(function () {
  ...
  function adicionarBoasVindas() {
    ...
    adicionarMensagemSimples(
      `Sou o Assistente Imob. Posso ajudar com acessos, erros comuns e orientações sobre Hypnobox, Webmail, Portal do Corretor e SIGAV.${empresa} Escolha uma pergunta rápida ou digite sua dúvida abaixo.`,
