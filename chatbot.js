/*
 * Assistente Imob
 * Pesquisa local, sem API externa e sem envio das perguntas para servidores.
 * A base utilizada está no arquivo base-conhecimento.js.
 */
(function () {
  'use strict';
  ...
  function categoriaDetectada(tokens) {
    ...
    if (texto.includes(' portal ') || texto.includes(' corretor ')) return 'Portal do Corretor';
  ...
  function criarBolha(tipo) {
    ...
    avatar.textContent = tipo === 'usuario' ? 'VC' : 'IM';
  ...
  function adicionarBoasVindas() {
    ...
    adicionarMensagemSimples(
      `Sou o Assistente Imob. Posso ajudar com acessos, erros comuns e orientações das plataformas.${empresa} Minhas respostas vêm de uma base aprovada pelo TI e não utilizam uma API externa.`,
