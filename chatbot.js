...
(function () {
  ...
  function adicionarBoasVindas(opcoes = {}) {
    const contexto = obterContexto();
    const empresa = contexto.nomeEmpresa ? ` Ambiente atual: ${contexto.nomeEmpresa}.` : ' Ambiente atual: Even Vendas.';
  ...
  function atualizarContextoAssistente() {
    ...
    status.textContent = contexto.nomeEmpresa
      ? `${contexto.nomeEmpresa} · ambiente único`
      : 'Even Vendas · ambiente único';
  }
