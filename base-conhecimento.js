...
window.BASE_CONHECIMENTO_IMOB_META = {
  ...
  "fontes": [
    ...
    {
      "titulo": "Regras internas Even Vendas — Gestão de Leads e Clientes",
      "referencia": "Orientação interna fornecida pelo TI"
    },
    {
...
window.BASE_CONHECIMENTO_IMOB = [
  {
    ...
    "resposta": "Na operação Even Vendas, as visitas vinculadas à jornada do cliente devem ser tratadas no Hypnobox. Localize o cliente na carteira e utilize as ações disponíveis no cadastro ou na timeline.",
    "passos": [
      "Acesse CRM > Clientes.",
  ...
  },
  {
    ...
    "passos": [
      "Atualize a página e confirme a operação Even Vendas.",
  ...
  },
  {
    ...
    "resposta": "Primeiro confira filtros, período e responsável. Se o cliente estava na sua carteira e deixou de aparecer, considere também o prazo interno de 30 dias: ao expirar, a FAC/cliente passa para a base do gerente e deve ser solicitada novamente a ele.",
    "passos": [
      "Limpe os filtros da tela e amplie o período da consulta.",
      "Pesquise pelo nome, telefone ou e-mail do cliente.",
      "Se o cliente estava anteriormente na sua carteira, verifique se o prazo de 30 dias pode ter expirado.",
      "Nesse caso, entre em contato com seu gerente para solicitar o redirecionamento.",
      "Se não for uma questão de prazo ou carteira, abra um chamado informando um exemplo."
    ],
    "acoes": [
      {
        "texto": "Consultar manual",
    ...
    "fonte": {
      ...
      "referencia": "Regra interna de carteira de clientes",
      "url": "https://documentacao.senior.com.br/hypnobox/manual-do-usuario/sobre-ferramenta/sobre-hypnobox/"
    }
  },
  {
  ...
  {
    "id": "hypnobox-prazo-cliente-corretor-30-dias",
    "categoria": "Hypnobox",
    "titulo": "Prazo de 30 dias do cliente na carteira do corretor",
    "perguntas": [
      "quanto tempo o cliente fica na minha carteira",
      "quanto tempo a fac fica com o corretor",
      "quando meu cliente expira",
      "quando minha fac expira",
      "qual o prazo da fac do corretor",
      "qual o prazo do cliente no hypnobox",
      "meu cliente venceu",
      "minha fac venceu",
      "cliente expirou da minha carteira",
      "fac expirou da minha carteira",
      "cliente saiu da minha carteira depois de 30 dias",
      "fac saiu da carteira do corretor"
    ],
    "palavrasChave": [
      "hypnobox",
      "cliente",
    ...
    "resposta": "Na operação Even Vendas, a FAC/cliente permanece na carteira do corretor por 30 dias. Ao expirar esse prazo, a FAC sai da carteira do corretor e passa para a base do gerente.",
    "passos": [
      "Acompanhe o prazo dos clientes da sua carteira no Hypnobox.",
      "Se a FAC/cliente expirar e sair da sua carteira, entre em contato com seu gerente.",
      "O gerente poderá direcionar novamente a FAC/cliente para o corretor, enquanto ela ainda estiver na base dele."
    ],
    "acoes": [
      {
        "texto": "Acessar Hypnobox",
    ...
    "fonte": {
      "titulo": "Regra interna Even Vendas — Gestão de Leads e Clientes",
      "referencia": "Orientação interna fornecida pelo TI"
    }
  },
  {
    "id": "hypnobox-recuperar-cliente-expirado-gerente",
    "categoria": "Hypnobox",
    "titulo": "Recuperar cliente que expirou para a base do gerente",
    "perguntas": [
      "meu cliente foi para o gerente",
      "minha fac foi para o gerente",
      "como recuperar cliente expirado",
      "como recuperar fac vencida",
      "como pegar meu cliente de volta",
      "meu cliente sumiu da carteira",
      "minha fac sumiu da carteira",
      "cliente expirou o que faço",
      "fac expirou o que faço",
      "o gerente consegue devolver meu cliente",
      "como o gerente devolve a fac para mim"
    ],
    "palavrasChave": [
      "hypnobox",
      "cliente",
    ...
    "resposta": "Se a FAC/cliente expirar na carteira do corretor, ela passa para a base do gerente. Para recebê-la novamente, o corretor deve entrar em contato com o gerente e solicitar o redirecionamento para sua carteira.",
    "passos": [
      "Confirme que a FAC/cliente não está mais na sua carteira.",
      "Entre em contato com seu gerente e informe qual cliente precisa ser redirecionado.",
      "Faça a solicitação dentro do período em que a FAC ainda estiver na base do gerente."
    ],
    "acoes": [
      {
        "texto": "Acessar Hypnobox",
  ...
  {
    "id": "hypnobox-prazo-base-gerente-30-dias",
    "categoria": "Hypnobox",
    "titulo": "Prazo de 30 dias do cliente na base do gerente",
    "perguntas": [
      "quanto tempo o cliente fica com o gerente",
      "quanto tempo a fac fica na base do gerente",
      "qual o prazo na base do gerente",
      "quanto tempo tenho para pedir meu cliente de volta",
      "quanto tempo tenho para recuperar a fac",
      "o cliente fica 30 dias com o gerente",
      "o que acontece depois que a fac vai para o gerente"
    ],
    "palavrasChave": [
      "hypnobox",
      "cliente",
    ...
    "resposta": "Depois de sair da carteira do corretor, a FAC/cliente permanece por 30 dias na base do gerente. Durante esse período, o corretor deve solicitar ao gerente o redirecionamento. Se esse prazo também terminar, a FAC segue para a base da empresa.",
    "passos": [
      "Entre em contato com o gerente durante os 30 dias em que a FAC estiver na base dele.",
      "Solicite o redirecionamento para sua carteira.",
      "Não deixe o segundo prazo expirar, pois depois a FAC poderá seguir para a base da empresa."
    ],
    "acoes": [
      {
        "texto": "Acessar Hypnobox",
  ...
  {
    "id": "hypnobox-cliente-base-empresa-oferta",
    "categoria": "Hypnobox",
    "titulo": "Cliente que passou para a base da empresa",
    "perguntas": [
      "meu cliente foi para a base da empresa",
      "minha fac foi para a base da empresa",
      "o que acontece depois de 60 dias",
      "outros corretores podem ofertar meu cliente",
      "quando outros corretores podem pegar o cliente",
      "cliente ficou disponível para oferta",
      "fac ficou disponível para oferta",
      "perdi o prazo com o gerente",
      "cliente saiu da base do gerente"
    ],
    "palavrasChave": [
      "hypnobox",
      "cliente",
    ...
    "resposta": "Se a FAC/cliente completar também os 30 dias na base do gerente sem ser redirecionada, ela passa para a base da empresa. A partir daí, outras pessoas podem ofertar esse cliente conforme as regras da operação.",
    "passos": [
      "Antes de chegar a essa etapa, solicite o redirecionamento ao gerente dentro do prazo da base dele.",
      "Se a FAC já estiver na base da empresa, consulte o gerente sobre a situação do cliente e as regras aplicáveis ao caso."
    ],
    "acoes": [
      {
        "texto": "Acessar Hypnobox",
  ...
  {
    "id": "hypnobox-atualizar-cliente-tarefa",
    "categoria": "Hypnobox",
    "titulo": "Como atualizar o cliente e renovar o atendimento",
    "perguntas": [
      "como atualizo meu cliente",
      "como atualizar cliente no hypnobox",
      "como atualizar uma fac",
      "como renovar o cliente",
      "como renovar a fac",
      "como evitar que o cliente expire",
      "o que atualiza o cliente",
      "o que renova o prazo do cliente",
      "comentario atualiza o cliente",
      "comentário atualiza o cliente",
      "comentario renova a fac",
      "comentário renova a fac",
      "colocar comentario atualiza o cliente",
      "comentário evita vencimento",
      "preciso fazer tarefa para atualizar cliente"
    ],
    "palavrasChave": [
      "hypnobox",
      "cliente",
    ...
    "resposta": "Para atualizar a FAC/cliente no Hypnobox, é necessário realizar uma tarefa vinculada ao atendimento. Inserir apenas um comentário não atualiza o cliente e não deve ser usado como forma de renovação do atendimento.",
    "passos": [
      "Abra o cliente no Hypnobox.",
      "Realize uma tarefa vinculada ao atendimento do cliente.",
      "Conclua a tarefa conforme o fluxo utilizado pela equipe.",
      "Não considere um comentário isolado como atualização do cliente."
    ],
    "acoes": [
      {
        "texto": "Acessar Hypnobox",
  ...
  },
  {
    ...
    "resposta": "Na Even Vendas, acesse o Hypnobox pelo card da Plataforma ou pelo endereço https://even.hypnobox.com.br. Digite novamente o usuário e a senha; se o acesso continuar negado, use a recuperação de senha ou abra um chamado informando a mensagem exibida.",
    "passos": [
      "Abra o Hypnobox pelo card da Plataforma Even Vendas para evitar um endereço incorreto.",
  ...
  },
  {
    ...
    "resposta": "Entre novamente pelo endereço correto da Even Vendas. Se a desconexão ocorrer repetidamente, teste uma janela anônima e verifique se o navegador está bloqueando cookies; persistindo, abra um chamado com o horário do ocorrido.",
    "passos": [
  ...
  },
  {
    ...
    "resposta": "Na operação Even Vendas, a oferta ativa de clientes é tratada no Hypnobox. Pela regra interna, quando uma FAC/cliente expira 30 dias na carteira do corretor e depois também completa 30 dias na base do gerente sem redirecionamento, ela pode seguir para a base da empresa, onde outras pessoas podem ofertar o cliente conforme as regras da operação.",
    "passos": [
      "Acesse o Hypnobox da Even Vendas.",
      "Para uma FAC que acabou de sair da carteira do corretor, procure primeiro o gerente e solicite o redirecionamento.",
      "A FAC permanece 30 dias na base do gerente antes de seguir para a base da empresa.",
      "Se já estiver na base da empresa, consulte as condições de oferta disponíveis para seu perfil."
    ],
    "acoes": [
      {
        "texto": "Acessar Hypnobox",
    ...
    "fonte": {
      "titulo": "Orientação interna TI e Manual oficial do Hypnobox",
      "referencia": "Regra interna de expiração e oferta",
      "url": "https://documentacao.senior.com.br/hypnobox/manual-do-usuario/crm/clientes/clientes/"
    }
  },
  {
    ...
    "resposta": "Na operação Even Vendas, toda a gestão da carteira de clientes é realizada no Hypnobox. Para manter uma FAC/cliente atualizada, é necessário realizar uma tarefa vinculada ao atendimento; inserir somente um comentário não atualiza o cliente.",
    "passos": [
      "Acesse o Hypnobox da Even Vendas.",
      "Entre na área Clientes para localizar a carteira e o cadastro desejado.",
      "Abra o cliente e realize as tarefas do atendimento conforme o fluxo da equipe.",
      "Para atualização do cliente, conclua uma tarefa; comentário isolado não renova a FAC/cliente.",
    ...
    "fonte": {
      "titulo": "Orientação interna TI e Manual oficial do Hypnobox",
      "referencia": "Regra interna de atualização do cliente",
      "url": "https://documentacao.senior.com.br/hypnobox/manual-do-usuario/crm/clientes/clientes/"
    }
  },
  {
  ...
  },
  {
    ...
    "resposta": "A Even Vendas utiliza o Hypnobox em https://even.hypnobox.com.br. Você também pode abrir o sistema diretamente pelo card Hypnobox da Plataforma.",
    "passos": [
      "Abra a Plataforma Even Vendas.",
      "Gere suas informações de acesso, se necessário.",
      "Clique no card Hypnobox."
    ],
    "acoes": [
      {
        "texto": "Consultar orientação oficial",
  ...
  },
  {
    ...
    "resposta": "Na operação Even Vendas, os leads e clientes são distribuídos pelo Hypnobox. A entrega pode seguir regras de fila, sorteio ou direcionamento e depende da configuração e disponibilidade do corretor.",
    "passos": [
      "Confirme se você está conectado ao Hypnobox da Even Vendas.",
  ...
  },
  {
    ...
    "passos": [
      "Abra o Hypnobox correspondente à Even Vendas.",
  ...
  },
  {
    ...
    "categoria": "Webmail",
    "titulo": "Configurar e-mail no Outlook do celular",
    "perguntas": [
      "configurar email skymail no outlook app",
      "colocar email corporativo no outlook celular",
      "configurar outlook no celular",
      "outlook app no android",
      "outlook app no iphone"
    ],
    "palavrasChave": [
      "webmail",
      "email",
    ...
    "resposta": "No aplicativo Outlook do celular, altere o provedor da conta para IMAP e abra as configurações avançadas. Use os servidores SkyMail com SSL/TLS; se as portas forem solicitadas, use IMAP 993 e SMTP 465.",
    "passos": [
  ...
  {
    "id": "webmail-configurar-outlook-windows",
    "categoria": "Webmail",
    "titulo": "Configurar e-mail SkyMail no Outlook do computador",
    "perguntas": [
      "como configurar meu email no outlook",
      "como configurar webmail no outlook",
      "configurar skymail no outlook",
      "configurar email corporativo no outlook",
      "colocar email da even no outlook",
      "como adicionar conta no outlook do computador",
      "configurar outlook windows imap",
      "qual servidor imap do skymail no outlook",
      "qual servidor smtp do skymail no outlook",
      "qual porta imap do skymail",
      "qual porta smtp do skymail",
      "outlook novo skymail",
      "new outlook skymail"
    ],
    "palavrasChave": [
      "webmail",
    ...
    "resposta": "Para configurar o SkyMail no Outlook do computador, use uma conta IMAP. Servidor de entrada: imap.skymail.net.br, porta 993 com SSL/TLS. Servidor de saída: smtp.skymail.net.br, porta 465 com SSL/TLS. Use o endereço de e-mail completo e a senha atual do Webmail.",
    "passos": [
      "No Outlook, escolha Adicionar conta e informe seu endereço de e-mail completo.",
      "Se necessário, abra Opções avançadas e escolha configurar a conta manualmente.",
      "Selecione IMAP.",
      "Entrada: imap.skymail.net.br — porta 993 — SSL/TLS.",
      "Saída: smtp.skymail.net.br — porta 465 — SSL/TLS.",
      "Informe a senha atual do e-mail e conclua a configuração.",
      "No Outlook clássico, se solicitado, habilite a autenticação do servidor de saída usando as mesmas credenciais do servidor de entrada.",
      "Faça um teste de envio e recebimento."
    ],
    "acoes": [
      {
        "texto": "Configuração IMAP no Outlook Windows",
        "tipo": "link",
        "url": "https://suporte.skynova.com.br/hc/pt-br/articles/7208496537492-Configurar-uma-conta-IMAP-e-gerar-PST"
      },
      {
        "texto": "Configuração no Novo Outlook",
        "tipo": "link",
        "url": "https://suporte.skynova.com.br/hc/pt-br/articles/26676728030356-Outlook-New-Configura%C3%A7%C3%A3o-conta-IMAP"
      }
    ],
    "suporte": {
      "tipo": "Ajuda com plataforma",
    ...
    "fonte": {
      "titulo": "SkyMail — Configuração IMAP no Outlook Windows",
      "url": "https://suporte.skynova.com.br/hc/pt-br/articles/7208496537492-Configurar-uma-conta-IMAP-e-gerar-PST"
    }
  },
  {
  ...
  },
  {
    ...
    "resposta": "Confirme o endereço do Webmail da Even Vendas e digite o e-mail corporativo completo. Se a senha não for aceita, tente alterá-la pelo próprio Webmail; se a opção não aparecer ou o acesso continuar bloqueado, abra um chamado.",
    "passos": [
  ...
  },
  {
    ...
    "resposta": "O Webmail da Even Vendas pode ser acessado em http://webmail.evci.com.br. Você também pode utilizar o card Webmail da Plataforma.",
    "passos": [
      "Gere suas informações de acesso na Plataforma.",
      "Abra o card Webmail.",
      "Entre com seu e-mail corporativo completo."
    ],
    "acoes": [
      {
        "texto": "Acessar Webmail",
  ...
  },
  {
    ...
    "passos": [
      "Gere as informações de acesso e abra o card Portal do Corretor."
    ],
    "acoes": [
      {
  ...
  },
  {
    ...
    "perguntas": [
      ...
      "qual o domínio do email even vendas",
    ...
    "resposta": "Na Even Vendas, o e-mail corporativo é formado pelo seu apelido seguido de @evci.com.br. Digite somente o apelido no campo da Plataforma para gerar o endereço.",
    "passos": [
      "Digite somente seu apelido, sem @ e sem domínio.",
      "Clique em Gerar informações de acesso.",
      "A Plataforma exibirá o endereço no formato apelido@evci.com.br."
    ],
    "acoes": [],
    "suporte": {
      "tipo": "Ajuda com plataforma",
  ...
  },
  {
    "id": "empresa-correta",
    "categoria": "Credenciais",
    "titulo": "Qual operação devo utilizar?",
    "perguntas": [
    ...
    "resposta": "A Plataforma é exclusiva da Even Vendas. Não é necessário selecionar uma empresa: os acessos, links, credenciais e orientações do Assistente Imob são direcionados à Even Vendas.",
    "passos": [
      "Digite seu apelido diretamente na tela inicial.",
      "Gere as informações de acesso.",
      "Use os cards disponibilizados para os sistemas da Even Vendas."
    ],
    "acoes": [
      {
        "texto": "Abrir chamado",
  ...
  },
  {
    ...
    "resposta": "Confirme a apelido e se a senha temporária já foi alterada. Como cada sistema pode ter uma senha atualizada em momentos diferentes, informe no chamado quais plataformas falharam.",
    "passos": [
      "Gere novamente o e-mail na operação Even Vendas.",
