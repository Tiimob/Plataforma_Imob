...
window.BASE_CONHECIMENTO_IMOB_META = {
  ...
  "fontes": [
    ...
    {
      "titulo": "Regras internas EVEN IMOB — Gestão de Leads e Clientes",
...
window.BASE_CONHECIMENTO_IMOB = [
  ...
  },
  {
    ...
    "resposta": "Na operação EVEN IMOB, a FAC/cliente permanece na carteira do corretor por 30 dias. Ao expirar esse prazo, a FAC sai da carteira do corretor e passa para a base do gerente.",
    "passos": [
    ...
    "fonte": {
      "titulo": "Regra interna EVEN IMOB — Gestão de Leads e Clientes",
      "referencia": "Orientação interna fornecida pelo TI"
    }
  },
  {
  ...
  },
  {
    ...
    "resposta": "Na operação EVEN IMOB, a oferta ativa de clientes é tratada no Hypnobox. Pela regra interna, quando uma FAC/cliente expira 30 dias na carteira do corretor e depois também completa 30 dias na base do gerente sem redirecionamento, ela pode seguir para a base da empresa, onde outras pessoas podem ofertar o cliente conforme as regras da operação.",
    "passos": [
  ...
  },
  {
    ...
    "resposta": "Na operação EVEN IMOB, toda a gestão da carteira de clientes é realizada no Hypnobox. Para manter uma FAC/cliente atualizada, é necessário realizar uma tarefa vinculada ao atendimento; inserir somente um comentário não atualiza o cliente.",
    "passos": [
